  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 0,
      from: 'bot',
      text: "Hi, I'm the Baltic Sea News assistant. Ask me about news, countries, topics, fact checks, or party positions.",
    },
  ]);
          ...
          >
            ...
            >
              <div className="flex items-center gap-2 text-white">
                ...
                <span className="text-sm font-semibold">Ask Baltic Sea News</span>
              </div>
              <button
            ...
            {(country || topic) && (
              <div className="border-b border-[#D1835A]/20 bg-white px-4 py-2 text-xs text-[#03353E]/70">
                Viewing: {country ? `${country.flag} ${country.name}` : 'All countries'}
                {topic ? ` · ${topic.label}` : ''}
              </div>
            )}
